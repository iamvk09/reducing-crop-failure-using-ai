...
TEXT = {
    "English": {
        ...
        "tab_live": "Live Crop Risk Prediction",
        "live_prediction_heading": "Live Crop Failure Risk Prediction",
        "live_weather": "Live Weather",
        "source_open_meteo": "Source: Open-Meteo",
        "updated": "Updated",
        "predict_button": "🔍 Predict Crop Failure Risk",
        "estimated_risk": "Estimated Crop Failure Risk",
        "disclaimer_title": "Advisory Disclaimer",
        "disclaimer_text": "This is a machine-learning estimate based on available data and is not a guarantee of crop failure.",
        "advanced_inputs": "Advanced Inputs",
        "data_provenance": "Data Sources & Provenance",
        "live_farmer_mode": "Farmer Mode",
        "live_expert_mode": "Expert Mode",
        "state": "State",
        "recommended_crops_title": "Recommended Crops",
        "why_risk": "Why is the risk at this level?",
        "digital_twin_live_title": "Digital Twin Scenario Simulation",
    },
    "Hindi": {
        ...
        "tab_live": "लाइव फसल जोखिम भविष्यवाणी",
        "live_prediction_heading": "लाइव फसल नुकसान जोखिम भविष्यवाणी",
        "live_weather": "लाइव मौसम",
        "source_open_meteo": "स्रोत: ओपन-मेटियो",
        "updated": "अपडेट किया गया",
        "predict_button": "🔍 फसल जोखिम का अनुमान लगाएं",
        "estimated_risk": "अनुमानित फसल विफलता जोखिम",
        "disclaimer_title": "सलाहकारी अस्वीकरण",
        "disclaimer_text": "यह उपलब्ध डेटा पर आधारित एक मशीन लर्निंग अनुमान है और फसल विफलता की कोई गारंटी नहीं है।",
        "advanced_inputs": "उन्नत इनपुट",
        "data_provenance": "डेटा स्रोत और विवरण",
        "live_farmer_mode": "किसान मोड",
        "live_expert_mode": "विशेषज्ञ मोड",
        "state": "राज्य",
        "recommended_crops_title": "अनुशंसित फसल विकल्प",
        "why_risk": "जोखिम इस स्तर पर क्यों है?",
        "digital_twin_live_title": "डिजिटल ट्विन परिदृश्य सिमुलेशन",
    },
}
